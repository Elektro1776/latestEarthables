...
export { childRoute, routeName, routeModel, routeIsStable, modelIsStable } from './ember-internals/common';

// These things are swapped out at build time based on the Ember
// version.
export { containingElement, initialize, getOutletStateTemplate } from './ember-internals/version-specific';