define('ember-light-table/mixins/table-column', ['exports', 'ember', 'ember-light-table/utils/call-action'], function (exports, _ember, _emberLightTableUtilsCallAction) {
  'use strict';
  ...
  exports['default'] = _ember['default'].Mixin.create({
    ...
    actions: {
      ...
      onColumnClick: function onColumnClick(column) {
        ...
        _emberLightTableUtilsCallAction['default'].apply(undefined, [this, 'onColumnClick'].concat(_slice.call(arguments)));
      },
      ...
      onColumnDoubleClick: function onColumnDoubleClick() /* column */{
        _emberLightTableUtilsCallAction['default'].apply(undefined, [this, 'onColumnDoubleClick'].concat(_slice.call(arguments)));
      }
    }
  });
});