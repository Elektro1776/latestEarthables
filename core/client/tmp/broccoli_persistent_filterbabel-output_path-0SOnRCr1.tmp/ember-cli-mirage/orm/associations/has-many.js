        ...
        Object.defineProperty(modelPrototype, key, {
          ...
          */
          set: function set(models) {
            ...
            if (this.isNew()) {
              association._cachedChildren = _instanceof(models, _emberCliMirageOrmCollection['default']) ? models : new _emberCliMirageOrmCollection['default'](association.target, models);
            } else {
